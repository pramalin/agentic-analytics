error id: file://<WORKSPACE>/application/src/main/java/com/example/agenticanalytics/config/ChatClientConfig.java
file://<WORKSPACE>/application/src/main/java/com/example/agenticanalytics/config/ChatClientConfig.java
### com.thoughtworks.qdox.parser.ParseException: syntax error @[21,78]

error in qdox parser
file content:
```java
offset: 907
uri: file://<WORKSPACE>/application/src/main/java/com/example/agenticanalytics/config/ChatClientConfig.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/application/src/main/java/com/example/agenticanalytics/config/ChatClientConfig.java